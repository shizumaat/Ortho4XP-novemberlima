...
**Status:** planned (2026-06-16). Build on a dedicated feature branch/worktree.
**Gate:** add `JUNCTION_CENTERLINE_SPINE` (config, env `O4_JCT_SPINE`, default OFF
→ gate-off byte-identical until shipped).
